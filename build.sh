...
case "$target" in
	...
	(cd lang/java/avro; mvn -Phadoop2 -Dhadoop.version=2 -P interop-data-generate generate-resources)
	...
	(cd lang/java; mvn -Phadoop2 package -DskipTests -Dhadoop.version=2; rm -rf mapred/target/classes/;
